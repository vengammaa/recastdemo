...
return concat($x/name/string(),
	...
	"~"  , "Layout ", string-join($x/content/layout/zone/(string-join(child/(concat("[child:[row:",@row/string(),", rowSpan:",@rowSpan/string(),", column:",@column/string(),", columnSpan:",@columnSpan/string(),", id:",@id/string(),"]]")),"|")), ";")
)		